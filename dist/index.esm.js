...
import React, { useState, useRef, useEffect, useImperativeHandle, useId, useCallback } from 'react';
...
function useGenerativeBlock(_a) {
    ...
    var _d = useState({ loading: true, data: null }), _e = _d[0], loading = _e.loading, data = _e.data, setState = _d[1];
...
function GenerativeComponent(_a) {
    ...
    var onMessageHandler = useCallback(function (e) {
    ...
    if (loading) {
        return (jsx("div", { className: cn('border-border/50 mx-auto flex h-full min-h-96 w-full max-w-sm animate-pulse rounded-md border bg-gray-50/5', className) }));
    }
    return (jsx(IframeResizer, { license: "GPLv3", log: true, forwardRef: ref, inPageLinks: true, onMessage: onMessageHandler, src: data === null || data === void 0 ? void 0 : data.url, className: cn(className, 'h-full w-full'), checkOrigin: ['https://pub-d6adf32ab3b94607ba3b3402d7fd4d20.r2.dev'], id: id }, id + '_' + 'iframe'));
}
